          ...
          {user ? (
            <>
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200/70 transition border border-slate-200 shadow-xs cursor-pointer"
              >
                <ShieldCheck className="w-4 h-4 text-emerald-600" />
                <span className="hidden sm:inline">Login Audit</span>
